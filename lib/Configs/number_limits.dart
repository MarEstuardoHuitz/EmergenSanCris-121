class Numberlimits {
  ...
  static int totaltxnXns = 200;
  static int totalhistorystore = 250;
  static int totalhistorydeleterange = 50;

  static const int totalnotificationstore = 250;
  static const int totalnotificationdeleterange =
      50; // to delete notification tilesy

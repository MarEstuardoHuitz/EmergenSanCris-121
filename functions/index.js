...
let isSendToAgent= message['sf'].includes(1);
       ...
       const multiLangNotifMap = {
            "ntm": "Nuevo mensaje de texto",
            "nim": "📷 Foto",
            "nvm": "🎥 Video",
            "nam": "🎙️ Grabación",
            "ncm": "👤 Contacto compartido",
            "ndm": "📄 Documento",
            "nlm": "📍 Ubicación actual compartida",
            "niac": "📞 Llamada de audio entrante",
            "nivc": "🎥 Videollamada entrante",
            "ce": "Llamada terminada",
            "mc": "Llamada perdida",
            "aorc": "Aceptar o rechazar la llamada",
            "cr": " todo Rechazado",
            "nr":"Nuevo mensaje en la Emergencia ID:",
            "cd":"Usuario",
            "ag":"Voluntario",
            "rbTC":"Nueva Emergencia Creada",
            "rbTDU":"Descripción de la emergencia actualizada",
            "rbTCL":"Emergencia Cerrada",
            "rbTA":"Agent(s) asignado en la emergencia",
            "rbRTC":"Solicitud de cierre de emergencia",
            "rbRA":"Requerir atención en la emergencia",
            "rbTRO":"Re-apertura de emergencia",
            "rbTCDC":"Cierre de emergencia denegado por el usuario",
            "rbTCDA":"Cierre de la emergencia denegado por el voluntario",
            "rbAMR":"Marca de atención eliminada",
            "rbAAC":"Voluntario asignado para la llamada",
            "rbARC":"Voluntario retirado de la llamada asignada",
            "rbNCT":"Nueva llamada sobre la emergencia",
            "TkID":"Emergencia ID",
...
if (message['ty'] == 0||message['ty'] == 1||message['ty'] == 2||message['ty'] == 3||message['ty'] == 4||message['ty'] == 5||message['ty'] == 6) {
     ...
     payload = {
            ...
            data: {
                'titleMultilang': "Nueva notificación",
                'bodyMultilang':   multiLangNotifMap['TkID']+": "+message.idf+" | "+message.tn,
                'title': "Nueva notificación",
                'body': multiLangNotifMap['TkID']+": "+message.idf+" | "+message.tn,
                'ticketIDfiltered':message.idf,
        ...
        if (isMultilangNotificationEnabled == true) {
            ...
            payload = {
                ...
                data: {
                    ...
                    'title': 'Tienes nuevo(s) mensaje(s)',
                    'body': 'Nuevo(s) mensaje(s) recibido(s).',
                    'peerid': message.fm,
            ...
            payload = {
                ...
                data: {
                    'titleMultilang': 'Tienes nuevo(s) mensaje(s)',
                    'bodyMultilang': 'Nuevo(s) mensaje(s) recibido(s).',
                    'title': 'Tienes nuevo(s) mensaje(s)',
                    'body': 'Nuevo(s) mensaje(s) recibido(s).',
                    'peerid': message.fm,
                    'agent_message_chat_id': message.id,
